...
import { FileText, Upload, Calendar, Filter, Download, Trash2, Eye, Search } from "lucide-react";
...
interface ArquivoDigitalProps {
  onClose?: () => void;
}

export function ArquivoDigital({ onClose }: ArquivoDigitalProps) {
