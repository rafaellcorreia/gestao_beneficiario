          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                min="0"
                step="0.5"
                placeholder="Digite o lapso temporal"
              />
              <p className="text-xs text-muted-foreground mt-1">
                {horasIniciais > 0 
                  ...
                  : 'Informe o lapso temporal. O total será calculado automaticamente.'}
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-muted-foreground mt-1">
                Máximo: {horasIniciais}h (total cadastrado) | O lapso temporal será recalculado automaticamente
              </p>
            </div>
          </div>
