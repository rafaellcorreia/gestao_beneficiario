...
export type StatusVida = 'Vivo(a)' | 'Morto(a)' | 'Preso(a)' | 'Enfermo(a)' | 'Licença Maternidade' | 'Devolvido(a)' | 'Concludente' | 'Aguardando Sentença' | 'Arquivado(a)' | 'Possível Concludente' | 'Extinto(a)';
